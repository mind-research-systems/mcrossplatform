...
public class FileResourceLocatorTest {
  ...
  public void fileExists_FileExistsInGivenDirectory_ReturnsTrue() {
    // arrange & act
    final boolean result = FileResourceLocator.fileExists(
        "./src/test/java/org/mcrossplatform/core/service/testservice", "HelloServiceImpl.java");
    // assert
    assertTrue(result);
  }
  ...
  public void testConstructorIsPrivate() throws NoSuchMethodException, IllegalAccessException,
    ...
    // arrange
    final Constructor<FileResourceLocator> constructor = FileResourceLocator.class
