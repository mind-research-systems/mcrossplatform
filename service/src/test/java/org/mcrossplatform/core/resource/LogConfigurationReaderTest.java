...
public class LogConfigurationReaderTest {
  private static final Level[] LOG_LEVELS = new Level[] { Level.ALL, Level.SEVERE, Level.WARNING,
      Level.INFO, Level.FINE, Level.FINER, Level.FINEST };
  private static final String[] LOG_MESSAGES = new String[] { "All", "Severe", "Warning", "Info",
      "Fine", "Finer", "Finest" };
  @Rule
  ...
  public void readLogProperties_PropertiesNotAFile_FileNotFoundException() {
    ...
    exception.expectMessage(
        "java.io.FileNotFoundException: ./src/test/resources/DirectoryNotAFile (Is a directory)");
    // act
  ...
  public void testConstructorIsPrivate() throws NoSuchMethodException, IllegalAccessException,
    ...
    // arrange
    final Constructor<LogConfigurationReader> constructor = LogConfigurationReader.class
