...
//		exception.expectMessage("./src/test/resources/DirectoryNotAFile (Is a directory)\" message was \"Exception while loading ./src/test/resources/DirectoryNotAFile");
	...
	public void loadProperties_FileExist_ContainsProperties() {
		...
		assertEquals("org.mcrossplatform.core.service.testservice.IHelloService",result.getProperty("service.interface.hello"));
		assertEquals("org.mcrossplatform.core.service.testservice.HelloServiceImpl",result.getProperty("service.implementation.hello"));
	}
